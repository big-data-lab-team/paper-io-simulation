...
axe = df_sim[files].plot.bar(stacked=True, rot=0, color="tab:purple", edgecolor="k")
...
plt.savefig("figures/fincore_wrench.svg", format="svg")
plt.savefig("figures/fincore_wrench.pdf", format="pdf")
