...
def compare_sep(real_time_file, real_mem_file,
    ...
    sim_subplot(ax3, simgrid_time_file, simgrid_mem_file, "WRENCH with page cache simulator", bar_alpha=0.2)
...
def real_subplot(subplot_ax, real_time_file, real_mem_file, xmin, xmax, ymin, ymax,
    ...
    if input_size == 20: subplot_ax.legend(fontsize='small', loc='upper right')
...
# compare_sep(real_time_file="real/%dgb/timestamps.csv" % input_size,
...
#             size=input_size, title="", xmin=0, xmax=200, ymin=-1000, ymax=280000)
