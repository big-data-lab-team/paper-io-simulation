...
%  Dzung: it's in GB
            ...
            of four tasks. The first two tasks are skull stripping and MGDM segmentation, 
            which are in this Nighres example: 
            \url{https://nighres.readthedocs.io/en/latest/auto_examples/example_01_tissue_classification.html}. 
            The last two steps are region extraction and CRUISE cortical reconstruction 
            in this example: 
