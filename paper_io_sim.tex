...
\maketitle
	...
	\section{Results}
		...
		As read and write bandwidths are symmetrical in SimGrid, we take the average values 
		to configure our simulators. 
		...
		\subsection{Multi-threaded experiment}
			...
			\begin{subfigure}{0.33\linewidth}
				\centering
   				\includegraphics[width=\linewidth]{result/multi/figures/makespan.pdf}
   				\caption{Total makespan}	
   				\label{fig:multi_makespan}
			\end{subfigure}	
			\begin{subfigure}{0.33\linewidth}
				\centering
   				\includegraphics[width=\linewidth]{result/multi/figures/readtime.pdf}
   				\caption{Average read time}	
   				\label{fig:multi_readtime}
			\end{subfigure}	
			\begin{subfigure}{0.33\linewidth}
				\centering
   				\includegraphics[width=\linewidth]{result/multi/figures/writetime.pdf}
