...
%  Dzung: it's in GB
    ...
    \label{discussion}
        ...
        %Furthermore, this level of accuracy
        %can be achieved without a fine-grained level of details
        %\tristan{not sure what you mean}. 
        % Dzung: I meant the results are accurate without a very detailed model. But the overhead results dot not seem to show that.
