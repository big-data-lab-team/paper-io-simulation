...
\maketitle
    ...
    writethrough modes.
        ...
        \subsection{Implementation}
            ...
            does not support concurrency: it is limited to single-threaded
            applications running on systems with a single-core CPU. We used
    ...
    \begin{figure*}
        ...
        \begin{subfigure}{\linewidth}
            \centering
               \includegraphics[width=\linewidth]{result/single/figures/single_errors_v2.pdf}
               \vspace*{-0.7cm}
               \caption{Relative simulation errors (absolute values)}
               \vspace*{0.5cm}
        ...
        \begin{subfigure}{\linewidth}
            ...
            %    Lines represent memory usage along pipeline execution time.}
               \includegraphics[width=\linewidth]{result/single/figures/single_memprof_v2.pdf}
               \vspace*{-0.7cm}
        ...
        \begin{subfigure}{\linewidth}
            \centering
               \includegraphics[width=1.05\linewidth]{result/single/figures/cached_files_v2.pdf}
               \caption{Page cache content after each I/O operation}
        ...
        previous observations were not incidental.
            ...
            \begin{figure*}
                \begin{subfigure}{\linewidth}
                    \centering
                    \includegraphics[width=0.8\linewidth]{result/multi/figures/multi_local.pdf}
                \end{subfigure}
            ...
            \begin{figure*}
                \begin{subfigure}{\linewidth}
                    \centering
                    \includegraphics[width=0.8\linewidth]{result/multi/figures/multi_nfs.pdf}
                \end{subfigure}
