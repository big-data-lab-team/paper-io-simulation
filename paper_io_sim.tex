	...
	\section{Results}
		...
		\subsection{Single-threaded experiment}
			...
			\begin{subfigure}{\linewidth}
				\centering
   				\includegraphics[width=\linewidth]{result/single/figures/errors.pdf}
			\end{subfigure}
		...
		\subsection{Multi-threaded experiment}
			...
			In this experiment, the results is analyzed with the average I/O time of concurrent pipelines.
			The results from real execution and simulation are presented in Figure~\ref{fig:multi_result}.
			
			The Figure~\ref{fig:multi_readtime} shows that as the number of pipelines 
			increases, the average read time raises accordingly because the amount of data 
