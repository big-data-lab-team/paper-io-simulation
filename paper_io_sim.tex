...
\maketitle
    ...
    \section{Methods}
    \label{method}
    \todo[inline]{HC: Personally, I would actually make this subsection a section, and rename the previous section from "Methods" to "Page Cache Simulation Model". I've never loved the "Methods" title for section, although I know it is standard practice for many authors. }
    ...
    \todo[inline]{HC: Not sure what "Absolute relative simulation errors" means in the caption of Figure~\ref{fig:single_error}. I assume it's a typo and you just mean "Relative"?}
    ...
    \begin{figure*}
        ...
        \subsection{Concurrent applications (Exp 2)}
            ...
            \todo[inline]{HC: I don't really see a plateau in Figure~\ref{fig:multi_local}}
