...
\maketitle
    ...
    application performance on arbitrary platform configurations. It thus comes
        ...
        to support research and development endeavors~\cite{ optorsim, gridsim, groudsim, cloudsim, nunez2012simcan,nunez2012icancloud, dissect_cf, cloudnetsimplusplus, fognetsimplusplus, casanova2014simgrid, ROSS, casanova2020fgcs}. 
    ...
    or uncached at all. A cached data block can only reside in one of the two
    ...
    The write simulation described above models page cache in writeback
    ...
    then evicts cache if needed and adds the written data to the cache.
        ...
        \subsection{Implementation}
            ...
            Since bandwidth sharing is not simulated, the prototype does not support
            ...
            users with the next WRENCH release. WRENCH provides a full SimGrid-based simulation 
        ...
        many analysis pipelines. The workflow is implemented as a Python
        ...
        bandwidth values in our experiments.
            ...
            \hline
            \end{tabularx}
            \caption{Task CPU time corresponding to input file size. \tristan{are the input files in GB or in GiB? If GiB, then change the abbreviation everywhere.}
