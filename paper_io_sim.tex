...
\maketitle
    ...
    \begin{figure*}
        ...
        from 212~\% in WRENCH to 68~\% in WRENCH-cache. Error
        reduction was mostly due to read times, since write
        times remained generally identical between both implementations, presumably due to 
