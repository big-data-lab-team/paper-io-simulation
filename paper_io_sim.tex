...
\maketitle
 ...
 % Swapped the order the two paragraphs and merged them into one
    ...
    \label{relatedwork}
        ...
        a cache hit, meaning the I/O can occur directly from memory without disk involvement.
        ...
        Neither \wrench nor \simgrid simulate page cache mechanisms.
    ...
    \begin{figure}
           ...
           \caption{Model of page cache LRU lists with data blocks. Grey blocks identify dirty data.}
           \label{fig:lrulist}
    \end{figure}
    ...
    is calculated, corresponding to a copy of the chunk in anonymous memory --- the memory that is not backed by any file ---
    ...
    writethrough modes.
        ...
        bandwidth values in our experiments. We aso used symmetrical bandwidths in the Python prototype 
        to facilitate comparison with \wrench-cache.
