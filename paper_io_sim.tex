...
\maketitle
    ...
    \begin{figure*}
        ...
        \subsection{Concurrent applications (Exp 2)}
            ...
            simulated and real read bandwidths mentioned before. For
            writes, \wrench-cache correctly retrieves the plateau ending at
            \tristan{x} concurrent applications in real life, corresponding
            to the limit beyond which the page cache was saturated with
            dirty data and needed flushing.
