...
\maketitle
    ...
    then evicts cache if needed and adds the written data to the cache.
        ...
        \subsection{Implementation}
            ...
            users with the next \wrench release. W\wrench provides a full \simgrid-based simulation 
...
%  Dzung: it's in GB
            ...
            simulates the Nighres CRUISE cortical reconstruction workflow
    ...
    \label{results}
        ...
        reality. Our explanation could be that we allocate anonymous memory 
        chunk-by-chunk to application, while anonymous memory is allocated 
        when as soon as task starts.
        As expected, dirty data remains under the
        ...
        in the inactive list. This may not correctly simulate what really happens 
        in reality. 
